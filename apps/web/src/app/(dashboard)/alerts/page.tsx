...
import { Bell, AlertTriangle, ShieldAlert, CheckCircle2, MoreHorizontal } from 'lucide-react';
          ...
          {alerts.length > 0 ? (
                ...
                <CardContent className="p-5">
                  <div className="flex flex-col sm:flex-row gap-4">
                    <div className={`w-12 h-12 rounded-full shrink-0 flex items-center justify-center ${
                      ...
                      {alert.severity === 'high' ? <ShieldAlert size={24} /> : <AlertTriangle size={24} />}
                    </div>
            ...
            <Card className="p-12 flex flex-col items-center justify-center text-center border-dashed border-2">
              ...
              <p className="text-slate-500 text-sm mt-2 max-w-xs">
                We will notify you here if there are any issues with your campaigns or system health.
              </p>
            </Card>
          )}
        </div>
