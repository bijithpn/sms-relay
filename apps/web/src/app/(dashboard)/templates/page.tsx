...
import { FileText, Plus, Search, Filter, Edit2, Trash2, X, Save } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50">
      <PageHeader 
        ...
        actions={
          <Button leftIcon={<Plus size={18} />} onClick={() => handleOpenModal()}>Create Template</Button>
        }
      />
          ...
          <CardContent className="p-0">
            <DataTable 
              ...
              columns={[
                ...
                { 
                  header: 'Last Updated', 
                  accessor: (item: any) => new Date(item.updatedAt).toLocaleDateString()
                },
                {
                  header: '',
                  accessor: (item: any) => (
