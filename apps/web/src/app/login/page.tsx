      ...
      <div className="w-full max-w-md z-10 space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400 text-sm">
            Professional SMS Testing & Analytics Platform
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-800/30 flex items-start gap-3">
          ...
          <p className="text-[11px] text-slate-400 leading-relaxed">
            <strong className="text-amber-500">Security Notice:</strong> Use
            this platform only for authorized SMS testing. Unauthorized use is
            strictly prohibited and subject to audit logging.
          </p>
        </div>
      </div>
    </div>
